export const ch = {
	...
	shortage: {
		...
		content:
			"過往透過民眾反映蒐集缺車站點，其實無法確認缺車嚴重程度與資源調配順序，透過分析全部站點數據後才得以了解缺車站點全貌。首先盤點上下班高峰時段(早上7-9點和下午5-7點)缺車嚴重站點並結合民眾反饋，由交通局於五月底新增1780台車輛至相關站點。平均將見車率提升約16%，緩解缺車需求。",
	...
	"dispatch-optimization": {
		...
		content:
			"除優先投車站點外，也盤點優化現有資源。以112年7月為例，供過於求站點約32站，統計平日閒置車輛，減少預留並移到他站使用。閒置柱位約390柱，亦配置他站使用。而見車率>90%且可減少>5輛調度站點，仍有調度優化空間。若進行調度，預計可減少調度員周間1,192輛調度工作。",
		"btn-1": "閒置車",
		"btn-2": "閒置柱",
		"btn-3": "調度量",
		"map-1": "閒置車優化",
	...
	"model-explanation": {
		...
		content:
			"周末出門但沒有YouBIke不方便？臺北大數據中心秉持數據治理的精神，透過蒐集各種與城市相關的開放資料，在空間上以250公尺見方的網格為最小單位，以每小時為單位並細分成週間週末，建立機器學習模型預測Youbike潛在借還車需求，期望找出需求高低優先序以滿足廣大市民朋友未來的使用需求。 ",
